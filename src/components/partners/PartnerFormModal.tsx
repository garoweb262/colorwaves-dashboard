    ...
    <Modal isOpen={isOpen} onClose={onClose} size="md">
      <div className="p-6 h-[80vh] flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-gray-900">{partner ? "Edit Partner" : "Add Partner"}</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          <div className="space-y-6 flex-1 overflow-y-auto pr-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-palette-violet ${errors.name ? "border-red-300" : "border-gray-300"}`}
